...
import com.example.myapplication.BoxText;
...
public class ObjectsTracker {
    ...
    private final BoxText borderedText;
    ...
    public ObjectsTracker(final Context context) {
        ...
        borderedText = new BoxText(textSizePx);
    }
    ...
    public synchronized void trackResults(final List<ImageClassifier.Recognition> results) {
    ...
    public synchronized void draw(final Canvas canvas) {
        ...
        for (final TrackedRecognition recognition : trackedObjects) {
            ...
            borderedText.drawText(canvas, trackedPos.left + cornerSize, trackedPos.bottom, labelString+"%"); //location of text
        }
    }
    ...
    private void processResults(final List<ImageClassifier.Recognition> results) {
        final List<Pair<Float, ImageClassifier.Recognition>> rectsToTrack = new LinkedList<>();

        screenRects.clear();
        final Matrix rgbFrameToScreen = new Matrix(getFrameToCanvasMatrix());

        for (final ImageClassifier.Recognition result : results) {
        ...
        trackedObjects.clear();
        for (final Pair<Float, ImageClassifier.Recognition> potential : rectsToTrack) {
